...
final class DeadMansSwitchResponderExtension extends Extension
{
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        ;
        $container->setAlias(ResponderFactoryInterface::class, 'dead_mans_switch.responder.factory');
        ...
        ;
        $container->setAlias(StatusCodeResolverInterface::class, 'dead_mans_switch.responder.status_code_resolver');
